...
plot2 = ggplot() +
geom_line(data = finalDataSet, aes(x = time, y = soilWatchSensor_2), color = "blue") +
  geom_line(data = finalDataSet, aes(x = time, y = soilTempC), color = "orange")+
  ylab("VWC(vol water/ vol soil) and Soil Temperature(c)")+
  ggtitle("Soil Moisture and Soil Temp vs Time") # for the main title
