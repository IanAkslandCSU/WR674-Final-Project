...
```{r}
qplot(x = time,y = EC5_1,data = fianlDataSet_long, main = "EC sensor VWC vs Time",
                                            geom = "line")
...
plot = ggplot() +
geom_line(data = finalDataSet_long, aes(x = time, y = EC5_1), color = "blue", size = .5, alpha=0.5) + 
  geom_line(data = finalDataSet_long, aes(x = time, y = EC5_4), color = "blue", size = .5, alpha=0.5) + 
  geom_line(data = finalDataSet_long, aes(x = time, y = precipProbability*100), color = "steelblue", size = .65, alpha=0.75) +
